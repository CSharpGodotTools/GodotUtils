...
public interface IBaseAutoloads
{
...
public partial class OptionsManager : IDisposable
{
    ...
    private readonly IBaseAutoloads _autoloads;
    private readonly StringName _fullscreenKey;
    #endregion

    public OptionsManager(IBaseAutoloads autoloads, StringName fullscreenKey)
    {
    ...
    public void Update()
    {
        if (Input.IsActionJustPressed(_fullscreenKey))
        {
            ToggleFullscreen();
        }
    }
