...
public class MetricsOverlay
{
    ...
    private readonly Dictionary<string, Func<object>> _monitors = [];
    private readonly Dictionary<string, Func<string>> _currentMetrics = [];

    private readonly StringName _toggleKeyAction;
    ...
    public MetricsOverlay(StringName toggleKeyAction)
    {
        _toggleKeyAction = toggleKeyAction;
