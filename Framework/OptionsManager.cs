...
namespace GodotUtils.Framework.UI;

public interface IResourceHotkeys
{
    Dictionary<StringName, Array<InputEvent>> Actions { get; set; }
}

public interface IHotkeysFactory
{
    IResourceHotkeys Create();
}
...
public partial class OptionsManager : IDisposable
{
    ...
    private IResourceHotkeys _hotkeys;
    private string _currentOptionsTab = "General";
    private AutoloadsFramework _autoloads;
    private readonly StringName _fullscreenInputAction;
    private readonly IHotkeysFactory _hotkeysFactory;
    #endregion

    public OptionsManager(AutoloadsFramework autoloads, StringName fullscreenInputAction, IHotkeysFactory hotkeysFactory)
    {
        _fullscreenInputAction = fullscreenInputAction;
    ...
    public void Update()
    {
        if (Input.IsActionJustPressed(_fullscreenInputAction))
        {
            ToggleFullscreen();
        }
    }
    ...
    public IResourceHotkeys GetHotkeys()
    {
        return _hotkeys;
    }
    ...
    {
        Error error = ResourceSaver.Save((Resource)_hotkeys, PathHotkeys);
