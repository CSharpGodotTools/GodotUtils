using GodotUtils.UI;
using GodotUtils;
using QualityP = GodotUtils.QualityPreset;
using VSyncMode = Godot.DisplayServer.VSyncMode;

// This was intentionally set to GodotUtils instead of GodotUtils as GodotUtils relies on MainMenuBtnPressed
// and GodotUtils should NOT have any trace of using GodotUtils.
